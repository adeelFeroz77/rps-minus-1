  ...
  return (
    <>
      <header className="fixed w-full top-0 p-4 bg-white/80 backdrop-blur-sm border-b border-slate-200 z-50 shadow-sm">
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <SignedOut>
              <SignInButton mode="modal">
                <button className="flex items-center gap-1.5 hover:text-blue-600 transition px-3 py-2 rounded-lg hover:bg-slate-50">
        ...
        {/* Mobile Menu Overlay */}
        <div
          className={`fixed inset-0 z-[60] ${isMobileMenuOpen
        ...
        >
          <div
            className={`absolute top-0 left-0 h-full w-64 bg-white shadow-xl transition-transform duration-300 ${isMobileMenuOpen ? "translate-x-0" : "-translate-x-full"
              }`}
